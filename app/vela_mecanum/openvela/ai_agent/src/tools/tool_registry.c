...
#ifdef CONFIG_AI_AGENT_FORMATION_TOOL
...
int tool_registry_init(void)
{
    ...
    REGISTER_TOOL(
        "formation_control",
        "Start, inspect, stop, or reset a guarded four-robot formation experiment. "
        "Use only predefined formations; never generate wheel-speed commands.",
        "{\"type\":\"object\",\"properties\":{"
        "\"action\":{\"type\":\"string\",\"enum\":[\"start\",\"status\",\"stop\",\"reset\",\"capabilities\"]},"
        "\"experiment_id\":{\"type\":\"string\",\"description\":\"Unique idempotency key for a start request\"},"
        "\"formation\":{\"type\":\"string\",\"enum\":[\"square\",\"line\",\"circle\",\"diamond\"]},"
        "\"control_mode\":{\"type\":\"string\",\"enum\":[\"anchored\",\"laplacian\",\"second_order\"],\"description\":\"Controller model; laplacian uses displacement consensus and second_order uses pinned double-integrator position/velocity feedback\"},"
        "\"spacing_m\":{\"type\":\"number\",\"minimum\":0.35,\"maximum\":2.5},"
        "\"duration_s\":{\"type\":\"number\",\"minimum\":1,\"maximum\":300},"
        "\"reason\":{\"type\":\"string\"}},\"required\":[\"action\"]}",
        tool_formation_execute);
#endif
