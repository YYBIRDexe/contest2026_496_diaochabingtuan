...
def main():
    ...
    for robot in ROBOT_IDS:
        subscriptions.append(node.create_subscription(PoseWithCovarianceStamped, f"/{robot}/amcl_pose", on_pose(robot), 10))
        subscriptions.append(node.create_subscription(LaserScan, f"/{robot}/scan_raw", on_scan(robot), 10))
